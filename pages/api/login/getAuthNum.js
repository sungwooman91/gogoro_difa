...
async function setUserInfo(customerInfoCurrentState) {
  ...
  const data = await prisma.$executeRaw`exec [dbo].[COMMON_CUSTOMER_Set_Insert] ${COMMON_EVENT_SERIAL}, ${USER_ID}, ${USE_BIT}, ${USER_TYPE}, ${USER_NAME}, ${PASSWORD}, ${EMAIL}, ${TEL_NO}, ${MEMO}, ${REGIST_IP}, null, null, 0;`;
