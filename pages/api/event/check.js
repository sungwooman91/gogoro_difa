...
export default async function handler(req, res) {
  ...
  if (req.method === "GET") {
    ...
    try {
      ...
      const data = await prisma.$queryRaw`exec [dbo].[COMMON_RESERVATION_Get_Hour] "1", ${COMMON_EVENT_SERIAL}, ${RESERVATION_TYPE}, ${RESERVATION_DATE}, ${USE_BIT}, ${out_result_code}, ${out_result_msg};`;
